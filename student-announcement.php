...
$sql = "SELECT * FROM student_announcement"; 
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="student-announcement.php">Student Announcement</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <h2>Create Student Announcement</h2>
        <form id="announcementForm" action="student-announcement-post.php" method="post">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <form class='delete-form' method='post' action='delete-announcement.php'>
                    ...
                    echo "<td colspan='5' class='text-center'>No announcements found.</td>";
                }
                ?>
            </tbody>
        </table>
