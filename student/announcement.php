...
// Check if the user is a student or the verified user
if ($_SESSION['userRole'] !== 'student' && $_SESSION['userId'] != $subject['userId']) {
    $_SESSION['error'] = "You do not have permission to access this page.";
    header("Location: ../../index.php");
    exit();
}

// Fetch announcements for student and studentTeachers
$query = "SELECT * FROM announcement WHERE view IN ('student', 'studentTeacher') ORDER BY id DESC";
